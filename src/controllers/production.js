...
module.exports = {
    ...
    update: async (req, res) => {
        ...
        res.status(202).send({
            isUpdated: Boolean(isUpdated[0]), data: await Production.findByPk(req.params.id)
        })
    },
    ...
    delete: async (req, res) => {
        ...
        res.status(isDeleted ? 204 : 404).send({
            ...
            message: isDeleted ? "Production deleted succesfully" : "Production not found or something went wrong."
        })
    }
